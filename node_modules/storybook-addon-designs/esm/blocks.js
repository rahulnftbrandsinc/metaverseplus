...
export var DocBlockBase = function (_a) {
    ...
    return (jsx(Html.ResetWrapper, null,
...
export var PDF = function (_a) {
    var placeholder = _a.placeholder, props = __rest(_a, ["placeholder"]);
    return (jsx(DocBlockBase, __assign({ placeholder: placeholder !== null && placeholder !== void 0 ? placeholder : 'Design (PDF)' }, props),
        jsx(PDFInternal, { config: __assign({ type: 'pdf' }, props) })));
};
